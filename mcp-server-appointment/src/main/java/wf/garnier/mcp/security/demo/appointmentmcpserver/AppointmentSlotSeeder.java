...
public class AppointmentSlotSeeder implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		for (int week = 0; week < 8; week++) {
			...
			repository.save(new AppointmentSlot(null, "Entrainement roller-soccer",
					LocalDateTime.of(wednesday, LocalTime.of(19, 0))));

			repository.save(new AppointmentSlot(null, "Entraînement rollball",
					LocalDateTime.of(wednesday, LocalTime.of(20, 30))));

			repository.save(new AppointmentSlot(null, "Cours roller street",
					LocalDateTime.of(saturday, LocalTime.of(14, 0))));

			repository.save(new AppointmentSlot(null, "Cours adultes: tous niveaux",
					LocalDateTime.of(sunday, LocalTime.of(14, 0))));

			repository.save(new AppointmentSlot(null, "Cours avancé",
